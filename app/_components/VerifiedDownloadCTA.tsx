    ...
    <div className={wrapperClasses}>
      ...
      {isPlaceholder ? (
        ...
        <a
          href={downloadPath}
          download={fileName}
          className="w-full bg-accent text-accent-foreground font-semibold rounded-lg px-6 py-3 inline-flex items-center justify-center gap-2 hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
